        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('barang_masuk.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                            <x-icon.plus/>
                            Create Barang Masuk
                        </a>
                        <a href="{{ route('barang_masuk.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Create new report">
                            <x-icon.plus/>
                        </a>
                    </div>
                </div>
