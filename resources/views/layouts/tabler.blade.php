                    ...
                    <div class="navbar">
                        <div class="container-xl">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown {{ request()->is('barang_masuk*', 'barang_keluar*') ? 'active' : null }}">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item" href="{{ route('barang_masuk.index') }}">
                                                    {{ __('Barang Masuk') }}
                                                </a>
                                                <a class="dropdown-item" href="{{ route('barang_keluar.index') }}">
                                                    {{ __('Barang Keluar') }}
                                                </a>
                                            </div>
                                        </div>
