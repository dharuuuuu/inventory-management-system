  ...
  <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-8 flex flex-wrap justify-between md:mb-16">
      <div class="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
        <h1 class="mb-4 text-4xl font-bold text-black sm:text-5xl md:mb-8 md:text-6xl">Kelola Gudang<br />& GO Digital</h1>

        <p class="max-w-md leading-relaxed text-gray-500 xl:text-lg">Mengelola Gudang dan Produk anda dengan mudah kapanpun dan dimanapun anda berada.</p>
      </div>
      ...
      <div class="mb-12 flex w-full md:mb-16 lg:w-2/3">
        <div class="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
          <img src="https://lh5.googleusercontent.com/p/AF1QipNzSMphcpa8gUcQST5xUAsL2fFFcngOqzlV6G6C?auto=format&q=75&fit=crop&w=550&h=550" loading="lazy" alt="GudangTani" class="h-full w-full object-cover object-center" />
        </div>

        <div class="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
          <img src="https://lh5.googleusercontent.com/p/AF1QipOggk5-x9YMMqGssyLne2JuIb2sVW-Uare5TIhz?auto=format&q=75&fit=crop&w=550&h=550" loading="lazy" alt="Photo by Manny Moreno" class="h-full w-full object-cover object-center" />
        </div>
      </div>
    </div>

    <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
      <div class="flex h-12 w-64">
        <a href="/register" class="px-10 flex rounded-lg items-center justify-center text-white bg-green-700 transition duration-100 hover:bg-green-700">Join Now</a>
      </div>

      <!-- social - start -->
      <div class="flex items-center justify-center gap-4 lg:justify-start">
        <span class="text-sm font-semibold uppercase tracking-widest text-green-700 sm:text-base">Social</span>
        <span class="h-px w-12 bg-gray-200"></span>

        <div class="flex gap-4">
          <a href="#" target="_blank" class="text-green-700 transition duration-100 hover:text-gray-500 active:text-gray-600">
